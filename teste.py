...
#teste = verifica_pressão_arterial(80, 80, 'feminino', 40, 'advanced')
#print(teste)
...
#Função 3- Calcula
#tfg = calcular_tfg(1.2, 60, sexo='feminino', raca='nao negra', output='ml/min/1.73m^2')
#print("TFG:", tfg)


# Função4- contagem de hemacias
#resultado_hemacias = contar_hemacias(8.9, "feminino","advanced")
#print("Métrica de hemácias:", resultado_hemacias)


# Função5- Contagem de leucócitos
#resultado_hemacias = contar_leucocitos(9.0,"simple")
...
#resultado = calcular_fcm(22,"feminino")
#print(resultado)
#resultado = calcular_fcm(16,"masculino")
#print(resultado)
#Função8- Frequencia respiratoria
#idade = 56
#fr = 17  # Frequência respiratória de exemplo
...
#resultado_advanced = calcular_tp(11.8,'advanced')
...
#resultado_advanced = calcular_ttpa(32.5,saida = 'advanced')
...
#tonus_muscular = 5
#reflexos = 4
#indice_apgar_total = calcular_indice_apgar(cor, frequencia_cardiaca, respiracao, tonus_muscular, reflexos,saida = "simple")
#print("Classificação do Índice de Apgar:", indice_apgar_total)


#Função13 - Concentração de Glicose no Sangue (Glicemia)
#resultado = classificar_glicemia(98)
#print(resultado)

#Função14 - Saturação de Oxigênio (SpO2)

#resultado = classificar_spo2(88)
#print(resultado)
...
#resultado_analise = classificar_espirometria(5.0, 4.0, 'masculino', 36)
...
#resultado = teste_funcao_renal(0.2,1.2,'simple')
#print(resultado)

#Função19 - Teste Função Hepatica
#resultado = teste_funcao_hepatica(ast=30, alt=40, alp=100, bilirrubina_total=1.0, bilirrubina_direta=0.2, bilirrubina_indireta=0.8, saida='advanced')
#print(resultado)
...
#resultado = verifica_pressão_arterial(110,80,"feminino", 44,'simple')
#print(resultado)
